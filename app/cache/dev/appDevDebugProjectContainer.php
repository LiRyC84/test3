...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'bd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c0951397_1' => 'getBd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c09513971Service',
            'bd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c0951397_2' => 'getBd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c09513972Service',
            'bd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c0951397_3' => 'getBd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c09513973Service',
            'c622012a86123b34f64e9866cd2382bed0430eb41c630543c57e98d0581d1649_1' => 'getC622012a86123b34f64e9866cd2382bed0430eb41c630543c57e98d0581d16491Service',
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/var/www/html/Projet/app/cache/dev/assetic/config'), true)));
    ...
    /**
     * Gets the 'bd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c0951397_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getBd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c09513971Service()
    {
        return $this->services['bd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c0951397_1'] = new \Swift_Transport_Esmtp_Auth_CramMd5Authenticator();
    }

    /**
     * Gets the 'bd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c0951397_2' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getBd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c09513972Service()
    {
        return $this->services['bd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c0951397_2'] = new \Swift_Transport_Esmtp_Auth_LoginAuthenticator();
    }

    /**
     * Gets the 'bd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c0951397_3' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getBd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c09513973Service()
    {
        return $this->services['bd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c0951397_3'] = new \Swift_Transport_Esmtp_Auth_PlainAuthenticator();
    }

    /**
     * Gets the 'c622012a86123b34f64e9866cd2382bed0430eb41c630543c57e98d0581d1649_1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function getC622012a86123b34f64e9866cd2382bed0430eb41c630543c57e98d0581d16491Service()
    {
        return $this->services['c622012a86123b34f64e9866cd2382bed0430eb41c630543c57e98d0581d1649_1'] = new \Symfony\Component\Form\ResolvedFormTypeFactory();
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_760a119b2e6ef609ec7cc66a5d5cbe899cf0b14d1f969aabe4ea9f3aff399472');
        ...
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/var/www/html/Projet/src/Test/Bundle/TestBundle/Entity')), 'Test\\Bundle\\TestBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('TestTestBundle' => 'Test\\Bundle\\TestBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/var/www/html/Projet/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['form.resolved_type_factory'] = new \Symfony\Component\Form\Extension\DataCollector\Proxy\ResolvedTypeFactoryDataCollectorProxy($this->get('c622012a86123b34f64e9866cd2382bed0430eb41c630543c57e98d0581d1649_1'), $this->get('data_collector.form'));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/var/www/html/Projet/app');
    }
    ...
    {
        $a = new \Swift_Transport_Esmtp_AuthHandler(array(0 => $this->get('bd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c0951397_1'), 1 => $this->get('bd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c0951397_2'), 2 => $this->get('bd831870575c343d2fa99fb3e0cac56181ee6f92e5db50235fb94cd8c0951397_3')));
        $a->setUsername(NULL);
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/var/www/html/Projet/src/Test/Bundle/TestBundle/Resources/views', 'TestTest');
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/var/www/html/Projet/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'doctrine_migrations.dir_name' => '/var/www/html/Projet/app/DoctrineMigrations',
