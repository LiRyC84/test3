...
class UserController extends Controller
{
     ...
     * @Method("POST")
     * @Template("TestTestBundle:User:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        if (!$entity) {
            throw $this->createNotFoundException('Erreur - Utilisateur introuvable!');
        }
    ...
    */
     ...
     * @Method("PUT")
     * @Template("TestTestBundle:User:edit.html.twig")
     */
